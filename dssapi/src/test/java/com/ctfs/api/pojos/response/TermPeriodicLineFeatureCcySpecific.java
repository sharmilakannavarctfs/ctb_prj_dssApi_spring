...
@Data
public class TermPeriodicLineFeatureCcySpecific {
    ...
    private ArrayList<TermPeriodicLineFeatureInterestRate> interestRates;
    private ArrayList<TermPeriodicLineFeatureFee> fees;
}
