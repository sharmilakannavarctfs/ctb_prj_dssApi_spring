...
public class RetrieveMessageService extends BaseExecutor {
    protected RetrieveMessageService(RestService restService, ApplicationProperties applicationProperties) {
        super(restService, applicationProperties,"MESSAGESERVICE_V1");
    }
    private final Logger log = LoggerFactory.getLogger(RetrieveMessageService.class);
    ...
    public void post(Object requestbody) throws URISyntaxException {
        try {
            ...
            stepDefinitionDataManager.addToStoredObjectMap("retrieveMessages", response);
