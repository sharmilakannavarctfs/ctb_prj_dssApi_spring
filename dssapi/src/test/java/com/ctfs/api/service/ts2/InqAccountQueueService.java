...
@RetailBankService
public class InqAccountQueueService extends BaseExecutor{

	protected InqAccountQueueService(RestService restService, ApplicationProperties applicationProperties) {
		super(restService, applicationProperties,"TS2SERVICE_V1");
		// TODO Auto-generated constructor stub
	}

	private final Logger log = LoggerFactory.getLogger(InqAccountQueueService.class);
	...
	public void post(Object requestbody) throws URISyntaxException {
		try {
			...
			setBody(requestbody);
			Response response = post(Endpoints.ts2_inqAccountQueue);
			stepDefinitionDataManager.addToStoredObjectMap("inqAccountQueueResponse", response);
