...
@RetailBankService
public class InqAccountforCustomCodeService extends BaseExecutor{

	protected InqAccountforCustomCodeService(RestService restService, ApplicationProperties applicationProperties) {
		super(restService, applicationProperties,"TS2SERVICE_V1");
		// TODO Auto-generated constructor stub
	}

	private final Logger log = LoggerFactory.getLogger(InqAccountforCustomCodeService.class);
	...
	public void post(Object requestbody) throws URISyntaxException {
		try {
			...
			setBody(requestbody);
			Response response = post(Endpoints.ts2_InqAccountforCustomCode);
			stepDefinitionDataManager.addToStoredObjectMap("inqAccountForCustomCode", response);
