...
public class GetLinkedAccountsService extends BaseExecutor{
	...
	private final Logger log = LoggerFactory.getLogger(GetLinkedAccountsService.class);
	...
	public void getLinkedAccountsWithToken(Object requestbody, Object token) {
		try {
			setBody(requestbody);
			setHeader(token);
			Response response = post(Endpoints.getLinkedAccounts);
	...
	public void getLinkedAccountsWithDisablePagination(Object requestbody, Object pagination) {
		try {
			setBody(requestbody);
