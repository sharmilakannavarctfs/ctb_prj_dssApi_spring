...
@RetailBankService
public class inquiryCvcService extends BaseExecutor{

	protected inquiryCvcService(RestService restService, ApplicationProperties applicationProperties) {
		super(restService, applicationProperties,"TS2SERVICE_V1");
		// TODO Auto-generated constructor stub
	}

	private final Logger log = LoggerFactory.getLogger(inquiryCvcService.class);
	...
	public void post(Object requestbody) throws URISyntaxException {
		try {
			...
			setBody(requestbody);
			Response response = post(Endpoints.ts2_inquiryCvc);
			stepDefinitionDataManager.addToStoredObjectMap("inquirycvcResponse", response);
