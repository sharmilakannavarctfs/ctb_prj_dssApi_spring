...
@RetailBankService
public class InqTriad8Service extends BaseExecutor{

	protected InqTriad8Service(RestService restService, ApplicationProperties applicationProperties) {
		super(restService, applicationProperties,"TS2SERVICE_V1");
		// TODO Auto-generated constructor stub
	}

	private final Logger log = LoggerFactory.getLogger(InqTriad8Service.class);
	...
	public void post(Object requestbody) throws URISyntaxException {
		try {
			...
			setBody(requestbody);
			Response response = post(Endpoints.ts2_inqTriad8);
			stepDefinitionDataManager.addToStoredObjectMap("inqTriad8Response", response);
