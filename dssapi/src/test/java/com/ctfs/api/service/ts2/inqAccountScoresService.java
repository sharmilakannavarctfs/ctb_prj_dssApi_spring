...
@RetailBankService
public class inqAccountScoresService extends BaseExecutor{

	protected inqAccountScoresService(RestService restService, ApplicationProperties applicationProperties) {
		super(restService, applicationProperties,"TS2SERVICE_V1");
		// TODO Auto-generated constructor stub
	}

	private final Logger log = LoggerFactory.getLogger(inqAccountScoresService.class);
	...
	public void post(Object requestbody) throws URISyntaxException {
		try {
			...
			setBody(requestbody);
			Response response = post(Endpoints.ts2_inqAccountScores);
			stepDefinitionDataManager.addToStoredObjectMap("inqAccountScoresResponse", response);
