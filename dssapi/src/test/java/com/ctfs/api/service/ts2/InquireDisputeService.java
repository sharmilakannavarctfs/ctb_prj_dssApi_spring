...
@RetailBankService
public class InquireDisputeService extends BaseExecutor{

	protected InquireDisputeService(RestService restService, ApplicationProperties applicationProperties) {
	...
	public void post(Object requestbody) throws URISyntaxException {
		try {
			...
			setBody(requestbody);
			Response response = post(Endpoints.ts2_inquireDispute);
			stepDefinitionDataManager.addToStoredObjectMap("inquireDisputeResponse", response);
