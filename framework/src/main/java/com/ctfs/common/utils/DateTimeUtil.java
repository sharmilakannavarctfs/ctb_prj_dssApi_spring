...
public class DateTimeUtil {
    ...
    private static final DateTimeFormatter ISO_DATE_FORMAT_NO_TIME_NOSPACE = DateTimeFormatter
            .ofPattern("MMddyyyy");
    ...
    private static final DateTimeFormatter ISO_DATE_FORMAT_FULL_NO_TIME = DateTimeFormatter
            .ofPattern("dd MMMM yyyy");

    private static final DateTimeFormatter ISO_DATE_FORMAT_FULL_DATE_NO_TIME = DateTimeFormatter
    ...
    public static String getShortDateStringNoSpace(String dateString) {
        LocalDate date = LocalDate.parse(dateString, ISO_DATE_FORMAT_SHORT_NO_TIME);
        return ISO_DATE_FORMAT_NO_TIME_NOSPACE.format(date);
    }
    ...
    public static String getDateStringFromDateString(String dateString) {
        LocalDate date = LocalDate.parse(dateString, ISO_DATE_FORMAT_SHORT_NO_TIME);
        return ISO_DATE_FORMAT_FULL_DATE_NO_TIME.format(date);
    }
    ...
    public static String getLongDateMonth() {
        return ISO_DATE_FORMAT_FULL_DATE_NO_TIME.format(getDateToday());
    }
